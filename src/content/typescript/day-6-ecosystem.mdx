...
**Bun** - The newest runtime focused on speed. Built-in TypeScript support, package manager, bundler, and test runner. Compatible with Node packages but much faster. We use Bun because it's simpler for learning.
